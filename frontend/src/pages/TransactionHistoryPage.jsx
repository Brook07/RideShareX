        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-green-100">
              ...
              <p className="text-2xl font-bold text-green-600">+NPR {balance.credits.toLocaleString()}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-red-100">
              ...
              <p className="text-2xl font-bold text-red-600">-NPR {balance.debits.toLocaleString()}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-200">
              ...
              <p className={`text-2xl font-bold ${balance.net >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {balance.net >= 0 ? '+' : ''}NPR {balance.net.toLocaleString()}
              </p>
            </div>
          </div>
        </div>
